...
export default function TopBar({ config }: TopBarProps) {
  return (
    <div className="bg-red-700 text-white text-xs animate-fade-in-down">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-8">
          <div className="flex items-center space-x-4">
            <span className="hidden md:inline font-bold uppercase tracking-wider animate-pulse">{config.site.portalTitle}</span>
            <span className="hidden lg:inline">|</span>
            <span className="hidden lg:inline animate-bounce-subtle">Hotline: {config.site.hotline}</span>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-1 animate-float-slow">
