                ...
                {status === 'success' ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      ...
                      className="w-full bg-red-700 text-white py-4 font-bold uppercase tracking-wider hover:bg-red-800 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                    >
                      {status === 'loading' ? (
